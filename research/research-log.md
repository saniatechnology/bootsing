...
| WCA2026 Architecture | barcelona.cat/capitalmundialarquitectura/en/programme | ⚠️ | 1310 activities, lazy-loaded/paginated. First page ≈ 20–24 Sep only. **October routes need pagination/browser automation** (known issue, see CONTEXT.md). |
