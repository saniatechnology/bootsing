...
export function CalendarApp({ initialEvents, meta }: CalendarAppProps) {
  ...
  return (
    <div className="wrap">
        ...
        <div className="controls">
          <div className="week-nav">
            ...
            <button
              type="button"
              className="nav-btn"
              onClick={() => setWeekIndex((i) => Math.min(lastWeek, i + 1))}
              disabled={weekIndex === lastWeek}
      ...
      <WeekSection week={week} events={events} meta={meta} activeGroup={activeGroup} />

      <footer className="note">
        Ask the chat box (bottom right) to add, edit, or remove events &mdash; it edits this
        calendar&rsquo;s data directly, and can search the web first when you ask it to look something up.
      </footer>
